...
struct AnimatedSideBar<Content: View, MenuView: View, Background: View>: View {
    ...
    var sideMenuWidth: CGFloat = AppSettings.sideMenu.menuWidth  //200
    var cornerRadius: CGFloat = 25
    var isSideMenuDraggable: Bool =  AppSettings.sideMenu.isSideMenuDraggable //true
    ...
    var body: some View {
        GeometryReader {
            ...
            .simultaneousGesture(isSideMenuDraggable ? dragGesture : nil)
        }
