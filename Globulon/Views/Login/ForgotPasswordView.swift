    ...
    var body: some View {
        ...
        VStack {
            ...
            if AppSettings.login.isKeychainLoginEnabled {
                HStack {
                    VStack(alignment: .leading) {
                        Text("This app uses local keychain authentication and if you have forgotten your password there is no way to recover it.  You will have to delete the app and it's data and start fresh.")
                        Spacer()
                    }
                    .foregroundColor(.txtColorFixed)
                    Spacer()
