...
////  OpExShellV1
////
////  Created by David Holeman on 8/5/24.
...
//                        HStack {
//                            Text("next")
//                                .foregroundColor(isPermissionAllowed ? .btnNextTracking : .gray)
//                            Image(systemName: "arrow.right")
//                                .resizable()
//                                .foregroundColor(isPermissionAllowed ? .white : .white)
//                                .frame(width: 30, height: 30)
//                                .padding()
//                                .background(isPermissionAllowed ? Color("btnNextTracking") : Color(UIColor.systemGray5))
//                                .cornerRadius(30)
//                        }
//                    }
//                    .disabled(isPermissionAllowed ? false : true)  // disable:enable the button
